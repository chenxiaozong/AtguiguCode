...
import com.example.chen.atguigucode.MainActivity;
...
public class DownloadService extends Service {
    ...
    private DownloadListener listener = new DownloadListener() {
        ...
        public void onProgress(int progress) {
            Log.d("DownloadService", "onprogress");
        ...
        public void onPaused() {
            Log.d("DownloadService", "onPaused");
            downloadTask = null;
        ...
        public void onCanceled() {
            Log.d("DownloadService", "onCanceled");
            downloadTask = null;
            stopForeground(true);
    ...
    class DownloadBinder extends Binder {
        public void startDownload(String url) {//创建异步下载任务
            if (downloadTask == null) {downUrl = url;
