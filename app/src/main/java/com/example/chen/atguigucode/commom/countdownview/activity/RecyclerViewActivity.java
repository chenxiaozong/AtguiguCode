package com.example.chen.atguigucode.commom.countdownview.activity;
...
public class RecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_countdown_recycler_view);
        initData();
    ...
    static class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_listview_countdownview, parent, false));
        }
